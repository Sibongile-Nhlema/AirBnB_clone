...
class TestBaseModel_1_save(unittest.TestCase):
    ...
    def test_save_once(self):
        ...
        base_model_1 = BaseModel()
        sleep(0.02)
        first_updated_at = base_model_1.updated_at
        base_model_1.save()
        self.assertLess(first_updated_at, base_model_1.updated_at)
    ...
    def test_save_twice(self):
        ...
        first_updated_at = base_model_1.updated_at
        base_model_1.save()
        second_updated_at = base_model_1.updated_at
        self.assertLess(first_updated_at, second_updated_at)
        sleep(0.02)
        base_model_1.save()
        self.assertLess(second_updated_at, base_model_1.updated_at)
